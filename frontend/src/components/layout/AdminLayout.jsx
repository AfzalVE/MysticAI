...
import {
  LayoutDashboard, Users, WandSparkles, ScrollText,
...
const navItems = [
  ...
  { path: '/admin/fortune-readings', name: 'Fortune Readings', icon: <WandSparkles size={18} /> },
          ...
          <nav className="space-y-1 px-3">
            {navItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-3 py-2 rounded-lg transition-colors font-sans text-sm ${isActive
